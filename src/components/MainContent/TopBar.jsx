    ...
    <div class="top-tab">
      <div class="heading">
        ...
        <div class="how_to_use">
          ...
          >
            <g clip-path="url(#clip0_15170_2522)">
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
      ...
      <div class="search">
        <svg
          ...
          xmlns="http://www.w3.org/2000/svg"
        >
          <g clip-path="url(#clip0_15170_2526)">
            <path
          ...
          <defs>
            <clipPath id="clip0_15170_2526">
              <rect width="16" height="16" fill="white" />
            </clipPath>
          </defs>
        </svg>
        <div class="search-text">Search features, tutorials, etc.</div>
      </div>
      <div class="more">
        <div>
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <g clip-path="url(#clip0_15170_2532)">
        ...
        <div>
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <g clip-path="url(#clip0_15170_2537)">
              <circle cx="20" cy="20" r="20" fill="#E6E6E6" />
              <path
