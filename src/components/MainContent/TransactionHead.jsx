  ...
  return (
    <div class="transaction-head">
      <div class="transaction-options">
        <div class="transaction-head-search">
          <svg
            width="14"
            height="14"
            viewBox="0 0 14 14"
          ...
          >
            <g clip-path="url(#clip0_15170_3685)">
              <path
        ...
        <div class="transaction-head-options">
          <div class="transaction-head-option-sort">
            <div>Sort</div>
            <svg
              width="14"
              height="12"
          ...
          <div class="transaction-head-option-download">
            <svg
              width="18"
              height="18"
              viewBox="0 0 18 18"
      ...
      <div class="transaction-row-headings">
        <div class="transaction-row-heading-left">Order ID</div>
        <div class="transaction-row-heading-left">
          Order date
          <svg
            width="8"
            height="6"
        ...
        <div class="transaction-row-heading-right">Order amount</div>
        <div class="transaction-row-heading-right">
          Transaction fees
          <svg
            width="14"
            height="14"
